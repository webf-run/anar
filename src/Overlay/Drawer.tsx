...
function DrawerContent(props: DrawerContentProps) {
  ...
  return (
    <AnimatePresence>
      {(rest?.isOpen || state?.isOpen) && (
        <DrawerOverlay
          isDismissable
          isOpen={rest?.isOpen || state?.isOpen}
          onOpenChange={rest?.onOpenChange || state?.setOpen}
...
function DrawerTitle(props: HeadingProps) {
  const { className, ...rest } = props;
  return (
    <Heading
      slot='title'
...
function DrawerDescription(props: TextProps) {
  const { className, ...rest } = props;
  return (
    <Text
      slot='description'
...
function DrawerClose(props: ButtonProps) {
